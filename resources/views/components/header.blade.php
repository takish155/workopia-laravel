...
<header class="bg-blue-900 text-white p-4">
  <div class="container mx-auto flex justify-between items-center">
      ...
      <nav class="hidden md:flex items-center space-x-4">
          ...
          <x-nav-link url="{{ url('/jobs/saved') }}" :active="request()->is('jobs/saved')">Saved Jobs</x-nav-link>
  ...
  >
    ...
    <x-nav-link url="{{ url('/jobs/saved') }}" :active="request()->is('jobs/saved')" :mobile="true">Saved Jobs</x-nav-link>
