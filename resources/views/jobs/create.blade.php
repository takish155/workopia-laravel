...
>
  ...
  >
    @csrf
      ...
      <x-inputs.text id="salary" name="salary" label="Annual Salary" placeholder="90000" />
      ...
      <x-inputs.select id="remote" name="remote" label="Remote" :options="['No' => 'false', 'Yes' => 'true']" />
      ...
      <x-inputs.text id="company_name" name="company_name" label="Company Name" placeholder="Acme Corp" />

      <x-inputs.text-area id="company_description" name="company_description" label="Company Description" placeholder="We are a software development company that specializes in building web applications..." />
